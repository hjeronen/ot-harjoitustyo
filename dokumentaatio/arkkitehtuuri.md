...
Pakkauksessa dao on Petin tallennuksesta vastaava luokka FilePetDao. Petin nimi, syntymäpäivä, aika jolloin sovellus suljettiin (Petin lastLogin) ja stattien tila kirjoitetaan tekstitiedostoon sovelluksen sulkeutuessa, samoin kun sovellus taas avataan tallennetun Petin tiedot luetaan ja asetetaan luodulle Pet-oliolle, jonka FilePetDao antaa takaisin oliolle PetCare. Tiedot tallennetaan String-muodossa ja puolipisteillä erotettuna, esim. 

```
Zorblax;2020-11-30;1607261049;98.00;99.00;100.00;99.00;true;false
```

Tallennuksessa on käytetty Data Access Object -mallia, ja pelilogiikan koodissa käsitellään rajapintaa PetDao varsinaisen FilePetDao-luokan sijasta, mikäli tallennusmetodia halutaan muuttaa myöhemmin. Myös PetCare-luokan testauksessa voidaan näin käyttää valekomponenttia, PetDao-rajapinnan toteuttavaa FakePetDao:a varsinaisen tallennustiedoston luomisen sijaan. Käyttöliittymän käynnistyessä luodaan olio FilePetDao, joka konstruktorissa injektoidaan PetCare-oliolle. FilePetDao tarpeen mukaan luo tai lataa tallennustiedoston "saveFile.txt". Koska pelissä on vain yksi käyttäjä ja yksi Pet (tällä hetkellä), on tallennustiedostojakin vain yksi.
...
![NimenantoSekvenssikaavio](https://user-images.githubusercontent.com/73843204/102486632-a17d0180-4069-11eb-8e70-6ddcda31b6dc.png)
